...
class StrukturUmurDisabilitasUsiaSekolahKelompokUmurImport implements ToModel, WithHeadingRow, WithChunkReading, WithBatchInserts, SkipsOnFailure, SkipsOnError, SkipsEmptyRows, WithValidation{
    ...
    public function model(array $row)
    {
        ...
        return new UsiaSekolahKelompokUmur($data);
    }
