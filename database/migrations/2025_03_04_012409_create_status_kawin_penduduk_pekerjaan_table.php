...
return new class extends Migration
{
    ...
    {
        Schema::create('status_kawin_penduduk_pekerjaan', function (Blueprint $table) {
            $table->id();
            ...
            foreach ($pekerjaan as $job) {
                $table->bigInteger($job . '_l'); // Laki-laki
                $table->bigInteger($job . '_p'); // Perempuan
            }
    ...
    {
        Schema::dropIfExists('status_kawin_penduduk_pekerjaan');
    }
};
