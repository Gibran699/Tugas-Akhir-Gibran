(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(
            document.getElementById("formSearchKepalaKeluargaUmurTunggal")
        );
        const atributTable = [
            'lk',
        'pr',
        ...
        $.ajax({
            url: $("#formSearchKepalaKeluargaUmurTunggal").attr("action"),
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                $("#tahunSemester").text(
                    `Penduduk Kepala Keluarga Umur Tunggal Tahun ${tahun} - Semester ${semester}`
                );
            },
            error: function (xhr) {
