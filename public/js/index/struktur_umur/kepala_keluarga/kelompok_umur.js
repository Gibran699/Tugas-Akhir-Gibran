(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(document.getElementById('formSearchKepalaKeluargaKelompokUmur'));
        const ageGroup = [
            '00_04_tahun_lk',
            '00_04_tahun_pr',
            '00_04_tahun_jml',
        ...
        $.ajax({
            url: $('#formSearchKepalaKeluargaKelompokUmur').attr('action'),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                $("#tahunSemester").text(`Penduduk Kepala Keluarga Kelompok Umur Tahun ${tahun} - Semester ${semester}`);
            },
            error: function (xhr) {
