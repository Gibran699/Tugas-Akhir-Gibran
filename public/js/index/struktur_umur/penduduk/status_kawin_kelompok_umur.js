(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(document.getElementById('formSearchPendudukStatusKawinKelompokUmur'));
        const ageGroup = [
        ...
        $.ajax({
            url: $('#formSearchPendudukStatusKawinKelompokUmur').attr('action'),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                $("#tahunSemester").text(`Penduduk Penduduk Status Kawin Kelompok Umur Tahun ${tahun} - Semester ${semester}`);
            },
            error: function (xhr) {
