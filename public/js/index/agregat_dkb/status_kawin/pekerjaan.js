(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(document.getElementById('formSearchStatusKawinPekerjaan'));
        const job = [
        ...
        $.ajax({
            url: $('#formSearchStatusKawinPekerjaan').attr('action'),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                $("#tahunSemester").text(`Status Kawin Pekerjaan Tahun ${tahun} - Semester ${semester}`);
            },
            error: function (xhr) {
