(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(document.getElementById('formPendudukGolonganDarah'));
        const blood = [
            'a_lk',
            'a_pr',
            'a_jml',
        ...
        $.ajax({
            url: $('#formPendudukGolonganDarah').attr('action'),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                setTableSum(response, blood, headerTable);
                ...
                $("#tahunSemester").text(`Penduduk Golongan Darah Tahun ${tahun} - Semester ${semester}`);
            },
            error: function (xhr) {
