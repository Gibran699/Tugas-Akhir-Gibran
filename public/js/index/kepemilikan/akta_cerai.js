(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(document.getElementById('formSearchKepemilikanAktaCerai'));
        const category = [
            'wajib_akta_cerai_lk',
            'wajib_akta_cerai_pr',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#tahunSemester").text(`Kepemilikan Akta Cerai Tahun ${tahun} - Semester ${semester}`);
            },
            error: function (xhr) {
