(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(document.getElementById('formSearchKepemilikanAktaKelahiran'));
        const category = [
            'wajib_akta_awal_lk',
            'wajib_akta_awal_pr',
            'wajib_akta_awal_jml',
        ...
        $.ajax({
            url: $('#formSearchKepemilikanAktaKelahiran').attr('action'),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                $("#tahunSemester").text(`Kepemilikan Akta Kelahiran Tahun ${tahun} - Semester ${semester}`);
            },
            error: function (xhr) {
