(function ($) {
    ...
    function fetchData() {
        var formData = new FormData(document.getElementById('formSearchKepemilikanAktaKawin'));
        const category = [
            'wajib_akta_kawin_lk',
            'wajib_akta_kawin_pr',
        ...
        $.ajax({
            url: $('#formSearchKepemilikanAktaKawin').attr('action'),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                $("#tahunSemester").text(`Kepemilikan Akta Kawin Tahun ${tahun} - Semester ${semester}`);
            },
            error: function (xhr) {
