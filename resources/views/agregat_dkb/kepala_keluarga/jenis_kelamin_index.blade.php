...
@section('content')
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Kepala Keluarga - Jenis Kelamin</a></li>
            </ol>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open([
                            'id' => 'formSearchKepalaKeluargaJenisKelamin',
                            'method' => 'post',
                            'route' => ['search_data', 'MNJiVyMrxR'],
                        ]) !!}
                        <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="chartKepalaKeluargaJenisKelamin" width="810" height="590"
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white">
                                        ...
                                        <small>Jumlah Kepala Keluarga Kota Samarinda</small>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="{{asset('js/index/agregat_dkb/kepala_keluarga/jenis_kelamin.js')}}"></script>
@endsection
