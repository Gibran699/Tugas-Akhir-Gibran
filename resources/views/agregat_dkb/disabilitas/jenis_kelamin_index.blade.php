...
@section('content')
    @php
        $disabilites = config('dataArray.categoryDisabilities');
    @endphp
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open([
                            'id' => 'formSearchDisabilitasJenisKelamin',
                            'method' => 'post',
                            'route' => ['search_data', 'trg1Xxialt'],
                        ]) !!}
                        <div class="row">
    ...
    <script src="{{ asset('js/index/agregat_dkb/disabilitas/jenis_kelamin.js') }}"></script>
@endsection
