...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open([
                            'id' => 'formSearchPendudukStatusKawinKelompokUmur',
                            'method' => 'post',
                            'route' => ['search_data', 'RIvQj7G1XZ'],
                        ]) !!}
                        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display table table-striped" id="tableSum">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase">Kelompok Umur & Status Kawin</th>
    ...
    <script src="{{ asset('js/index/struktur_umur/penduduk/status_kawin_kelompok_umur.js') }}"></script>
@endsection
