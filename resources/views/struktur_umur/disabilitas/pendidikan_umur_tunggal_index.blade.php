...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open([
                            'id' => 'formSearchDisabilitasPendidikanUmurTunggal',
                            'method' => 'post',
                            'route' => ['search_data', 'nx8eUW4TWq'],
                        ]) !!}
                        <div class="row">
    ...
    <script src="{{ asset('js/index/struktur_umur/disabilitas/pendidikan_umur_tunggal.js') }}"></script>
@endsection
