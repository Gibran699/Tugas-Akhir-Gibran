...
@endphp
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Akta Cerai</a></li>
            </ol>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open([
                            'id' => 'formSearchKepemilikanAktaCerai',
                            'method' => 'post',
    ...
    <script src="{{ asset('js/index/kepemilikan/akta_cerai.js') }}"></script>
@endsection
