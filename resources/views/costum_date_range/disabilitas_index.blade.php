...
@endphp
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Disabilitas</a></li>
            </ol>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open([
                            'id' => 'formSearchDateRangeAgeDisabilitas',
                            'method' => 'post',
                            'route' => ['search_data', 'B5nR8yT3sK'],
                        ]) !!}
                        <div class="row">
    ...
    <script src="{{asset('js/index/date_range/disabilitas.js')}}"></script>
@endsection
