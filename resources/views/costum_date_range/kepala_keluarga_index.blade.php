...
@endphp
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Kepala Keluraga</a></li>
            </ol>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        {!! Form::open([
                            'id' => 'formSearchDateRangeKepalaKeluarga',
                            'method' => 'post',
                            'route' => ['search_data', '3XwN7zYqF1'],
                        ]) !!}
                        <div class="row">
    ...
    <script src="{{asset('js/index/date_range/kepala_keluarga.js')}}"></script>
@endsection
