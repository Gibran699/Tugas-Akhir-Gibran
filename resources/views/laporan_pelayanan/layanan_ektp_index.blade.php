...
@section('content')
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">EKTP</a></li>
            </ol>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="ktpTable" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Tanggal</th>
                                        <th>Total Cetak</th>
    ...
    <script src="{{ asset('js/pelayanan/cetak_ktp.js') }}"></script>
@endsection
